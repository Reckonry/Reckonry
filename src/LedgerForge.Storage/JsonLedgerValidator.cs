...
{
    public const string CurrentSchemaVersion = "ledgerforge-ledger-v1";
    ...
    public LedgerValidationResult ValidateJson(string json)
    {
        ...
        using (document)
        {
            ...
            {
                return new LedgerValidationResult(["$ must be an object using the LedgerForge ledger v1 wrapper."]);
            }
