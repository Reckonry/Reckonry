...
public sealed class JsonLedgerStore : ILedgerStore
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        throw new InvalidDataException("Ledger JSON must be a LedgerForge v1 ledger object or a legacy event array.");
    }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var ledger = new Ledger(
            ...
            new LedgerMetadata(DateTimeOffset.UtcNow, "LedgerForge", events.Count),
            events.ToArray());
