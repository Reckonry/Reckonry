...
This directory is for public, official reference material used to review Reckonry tax-adjacent implementation notes.

## Privacy Classification

- These files must be public official documents only.
- Do not store private taxpayer files, exchange exports, generated reports, filled tax forms, account statements, correspondence, or working papers here.
- Do not store documents containing private names, addresses, fiscal codes, bank data, wallet addresses, transaction hashes, or account identifiers.

## Current Source Set

`docs/sources/agenzia-entrate/` contains public Agenzia delle Entrate reference PDFs for the Italian 2026 tax form review work.
